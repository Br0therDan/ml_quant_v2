...
## 8. 최종 대시보드 통합 완성
- **Data Monitor**: Ingest -> Feature -> Label 파이프라인 모니터링
- **Predictions**: 전문가 앙상블 기반 실시간 예측 점수 조회
- **Portfolio**: Top-K 기반 투자 비중 및 추천 지시서 확인
- **Backtest Summary**: 누적 수익률 곡선(Equity Curve) 및 성과 지표 시각화
